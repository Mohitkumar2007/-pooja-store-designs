// ============================================
// Utsav Pooja Store — Cart Engine (in-memory, vanilla JS)
// ============================================

const WHATSAPP_NUMBER = "91XXXXXXXXXX"; // placeholder — replace with real shop number

const products = [
  { id: 1,  name: "Brass Diya — Small",              cat: "Diyas",    emoji: "🪔", price: 149,  bg: "linear-gradient(150deg,#FFE29A,#FF6B35)", tag: "Bestseller" },
  { id: 2,  name: "Sandalwood Agarbatti (20 sticks)", cat: "Incense",  emoji: "🕯️", price: 89,   bg: "linear-gradient(150deg,#FFD3A6,#E63946)" },
  { id: 3,  name: "Steel Pooja Thali Set",            cat: "Thali",    emoji: "🍽️", price: 499,  bg: "linear-gradient(150deg,#FFE9B8,#FFB800)" },
  { id: 4,  name: "Fresh Coconut (Pair)",             cat: "Coconuts", emoji: "🥥", price: 60,   bg: "linear-gradient(150deg,#D9F2C4,#2D9C5A)" },
  { id: 5,  name: "Pure Camphor (50g)",                cat: "Camphor",  emoji: "✨", price: 40,   bg: "linear-gradient(150deg,#FFF3C4,#FFB800)" },
  { id: 6,  name: "Kumkum & Haldi Combo",              cat: "Kumkum",   emoji: "🌼", price: 75,   bg: "linear-gradient(150deg,#FFD6E8,#D6336C)" },
  { id: 7,  name: "Brass Ganesh Idol",                 cat: "Idols",    emoji: "🕉️", price: 899,  bg: "linear-gradient(150deg,#FFE29A,#E63946)", tag: "Trending" },
  { id: 8,  name: "Marigold Flower Garland",           cat: "Garlands", emoji: "🌺", price: 120,  bg: "linear-gradient(150deg,#FFD3A6,#D6336C)" },
  { id: 9,  name: "Cotton Wicks — Batti Pack",         cat: "Wicks",    emoji: "🧵", price: 35,   bg: "linear-gradient(150deg,#FFF3C4,#FF6B35)" },
  { id: 10, name: "Havan Samagri Kit",                  cat: "Havan",    emoji: "🔥", price: 249,  bg: "linear-gradient(150deg,#FFCF9E,#E63946)", tag: "Combo" },
];
...
function buildWhatsAppMessage() {
  ...
  return (
    `Hi! I'd like to order the following from Utsav Pooja Store:\n\n` +
    lines.join("\n") +
